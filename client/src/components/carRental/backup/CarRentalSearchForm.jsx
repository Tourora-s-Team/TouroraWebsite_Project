...
const CarRentalSearchForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Kiểm tra nếu không có token đăng nhập vẫn cho tìm kiếm
    fetch("http://localhost:3001/api/car-rentals/search", {
      method: "POST",
      headers: {
  ...
  return (
    <div className={styles.carRentalForm}>
      <div className={styles.modeSelector}>
        <button
          type="button"
          className={`${styles.modeButton} ${form.mode === "driver" ? styles.active : ""}`}
